...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
            ControlToValidate="TextBox7" ErrorMessage="Enter the contact no"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TextBox8" runat="server" Height="134px" TextMode="MultiLine" 
            Width="268px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
            ControlToValidate="TextBox8" ErrorMessage="Enter the address"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                            ControlToValidate="TextBox1" ErrorMessage="Username is blank"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
            ...
            ControlToValidate="TextBox6" ErrorMessage="Must Enter the answer"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                            <td>
                                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Submit" CssClass="btn btn-success btn-large" />
                                </td>
                            </tr>                           
                        </table>
