                            ...
                            <tr>
                                <td>
                                    <table cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Button ID="LoginButton" runat="server" CommandName="Login" CssClass="btn btn-primary" 
                                                    Text="Log In" ValidationGroup="Login1" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:HyperLink ID="CreateUserLink" runat="server" NavigateUrl="AdminLogin.aspx">Sign-In as Administrator</asp:HyperLink>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" colspan="2">
